...
import { getContext, executeAsync } from 'file:///home/joaocorreia/dndsheet/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///home/joaocorreia/dndsheet/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/joaocorreia/dndsheet/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/joaocorreia/dndsheet/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///home/joaocorreia/dndsheet/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///home/joaocorreia/dndsheet/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/joaocorreia/dndsheet/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-dtlwvx5w.mjs')
  },
  {
    name: "ficha-id",
    path: "/ficha/:id()",
    component: () => import('./_id_-0W6lgLnk.mjs')
  },
  {
    name: "ficha",
    path: "/ficha",
    component: () => import('./index-7aCvNmNe.mjs')
  },
  {
    name: "fichas",
    path: "/fichas",
    component: () => import('./index-CTnGDE7l.mjs')
  },
  {
    name: "cadastro",
    path: "/cadastro",
    component: () => import('./index-szSMMZI8.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BN1koElT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DhHX51xE.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useRequestFetch as d, entry$1 as default, useRouter as e, fetchDefaults as f, useRuntimeConfig as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
